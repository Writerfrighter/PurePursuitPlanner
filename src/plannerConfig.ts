...
export const DEFAULT_OBSTACLES: Obstacle[] = [
  ...
  { id: 'depot_b', cx: FIELD.width - 27/2, cy: FIELD.height/2 + 42/2 + 75.93, w: 27, h: 42, label: 'Blue DEPOT', color: 'rgba(74,158,255,.45)', blocked: false, category: 'depot' },
  { id: 'depot_r', cx: 27/2, cy: FIELD.height/2 - 42/2 - 75.93, w: 27, h: 42, label: 'Red DEPOT', color: 'rgba(255,90,90,.45)', blocked: false, category: 'depot' },
